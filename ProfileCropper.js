...
const ProfileCropper = props => {
  ...
  return React.createElement(
    ...
    React.createElement(
      PinchGestureHandler,
      {minPointers: 2, onGestureEvent: pinchGestureHandler},
      React.createElement(
        Animated.View,
        {style: [{width, height}, pinchStyle]},
        React.createElement(
          Animated.View,
          {style: [{width, height}]},
          React.createElement(
            PanGestureHandler,
            {maxPointers: 1, onGestureEvent: panGestureHandler},
            React.createElement(
              Animated.View,
              {style: [{width, height}]},
              React.createElement(
